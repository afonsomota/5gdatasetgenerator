...
def get_default_configuration(mode="standard", out_folder="traffic-traces-standard", static=0.005, timeout=30400):
  return {
    ...
    "overwrite": False,
    "timeout": timeout,
    # "trace_folder": "../sinr-map/small-berlin-out",
    "trace_folder": "../sinr-map/small-berlin-long-out/",
    "scene_conf_file": "../sinr-map/small-berlin-long-out/sim.config",
    "snr_file": "../sinr-map/small-berlin-long-out/max_snr_per_pos.pkl",
